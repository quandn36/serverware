            ...
            <div class="card m-b-30">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="title" class="form-control" required placeholder="Enter name" value="{{ $customer->name }}" />
                    </div>
                    <div class="form-group">
                        <label for="email">Email <span class="required">*</span></label>
                        <input type="text" name="email" id="email" readonly class="form-control" required placeholder="Email of customer value" value="{{ $customer->email }}" />
                    </div>
                    <div class="form-group">
                        <label for="company">Company <span class="required">*</span></label>
                        <input type="text" name="company" id="company" class="form-control" required placeholder="Enter company name" value="{{ $customer->company }}" />
                    </div>
                </div>
            </div>
        </div>
