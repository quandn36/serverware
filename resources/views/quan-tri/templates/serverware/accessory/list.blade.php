    ...
    <div class="col-xl-12">
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <a href="{{ route('accessory.create') }}" class="btn btn-success waves-effect waves-light mb-4 choose-categorytree"><i class="fas fa-plus-square"></i> Add new</a>
                </div>
                    ...
                    <table id="table-categorys" class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="thead_cursor_change" scope="col">Price</th>
        ...
        $('#table-categorys').DataTable({
            ...
            drawCallback:function() {
                ...
                $('.btn-delete').click(function() {
                    ...
                    alertify.confirm('<b>Confirm Delete</b></br>Are you sure to delete accessory has name "' + mTitle + '" ?', function (ev) {
                        ev.preventDefault();
                        $.ajax({
            ...
            columns: [
                ...
                { data: 'product_category_name',bSortable: false},
