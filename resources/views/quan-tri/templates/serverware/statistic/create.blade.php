            ...
            <div class="card m-b-30">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="title" class="form-control" required placeholder="Name of Supplier "/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="telephone" id="telephone" class="form-control" required placeholder="telephone... "/>
                    </div>
                </div>
            </div>
        </div>
